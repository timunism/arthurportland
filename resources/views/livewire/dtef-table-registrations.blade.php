        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <tbody>
                            @foreach ($students as $student)
                                ...
                                <tr wire:key="1" class="border-b dark:border-gray-700">
                                    ...
                                    @endphp
                                    <a href="{{ route('dtef.editregistration', $user_id->id) }}" wire:navigate class="px-3 py-1 bg-purple-500 hover:bg-purple-600 text-white font-semibold rounded">View</a>
                                    @if ($student->dtef_register !== 'successful')
                                        <a href="{{ route('dtefregistration.entry', $user_id->id)}}" class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white font-semibold rounded">Submit</a>
                                    @else
                ...
                <div class="flex justify-center mt-5 ">
                    <a href="{{ route('dtefregistration.bulk')}}" class="px-3 py-1 border-2 border-green-500 bg-transparent text-green-500 font-semibold rounded">Bulk Submission</a>
                </div>
                <div class="py-4 px-3">
                    <div class="flex ">
