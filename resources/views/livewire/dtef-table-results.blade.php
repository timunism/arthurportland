                        ...
                        <tbody>
                            @foreach ($students as $student)
                                ...
                                <tr wire:key="1" class="border-b dark:border-gray-700">
                                    ...
                                    @endphp
                                    <a href="{{ route('dtef.editresult', $user_id->id) }}" wire:navigate class="px-3 py-1 bg-purple-500 hover:bg-purple-600 text-white font-semibold rounded">View</a>
                                    @if ($student->dtef_result !== 'successful')
                                        <a href="{{ route('dtefresult.entry', $user_id->id)}}" class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white font-semibold rounded">Submit</a>
                                    @else
